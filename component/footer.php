<<<<<<< HEAD
<div class="footer fixed-bottom bg-dark text-light mt-5">
=======
...
>>>>>>> efd877c94bc47b018ab33d01af516dd3c4c536fd
        ...
        <div class="row align-items-start">
          ...
          <div class="col">
            <ul>
                <li><a href="../page/aboutPage.php" class="text-light">About</a></li>
                <li><a href="../page/home.php" class="text-light">Home</a></li>
                <li><a href="../page/agreementPage.php" class="text-light">Agreement</a></li>
            </ul>
          </div>
          <div class="col text-center">
