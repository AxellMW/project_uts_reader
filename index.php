        ...
        ></a>
          ...
          <i class="nav-item dropdown">
            ...
            <ul class="dropdown-menu nav-item" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="loginAdmin.php">Log in as Admin</a></li>
                ...
                <div class="card text-dark bg-light ma-5 shadow" style="min-width: 25rem;">
                    ...
                    <div class="card-body">
                        <form action="process\loginProcess.php" method="post">
                            ...
                            <p class="mt-2 mb-0">Belum punya akun ? <a href="page/registerPage.php" class="textprimary">Klik Disini!</a></p>
                    </div>
                </div>
            </div>
        </div> 
